...
internal class SqlExpressionNode : SqlNode
{
    public SqlExpressionNode(SqlSyntaxKind kind, SqlNode? parent = null, List<SqlSyntaxElement>? elements = null) : base(kind, parent, elements)
    {
    }

    /// <summary>
    /// The alias text for this expression, or <c>null</c> if no alias was detected.
    /// </summary>
    ...
    {
        var copy = new SqlExpressionNode(Kind, null, new List<SqlSyntaxElement>(Elements.Count)) { Alias = Alias };
